...
{
    [TestClass()]
    public class fn_remove_letters : SqlDatabaseTestClass
    {

        public fn_remove_letters()
        {
            InitializeComponent();
        }
        ...
        [TestMethod()]
        public void dbo_fn_remove_lettersTest()
        {
            SqlDatabaseTestActions testActions = this.dbo_fn_remove_lettersTestData;
        ...
        [TestMethod()]
        public void TableNaming()
        {
            SqlDatabaseTestActions testActions = this.TableNamingData;
            // Execute the pre-test script
            // 
            System.Diagnostics.Trace.WriteLineIf((testActions.PretestAction != null), "Executing pre-test script...");
            SqlExecutionResult[] pretestResults = TestService.Execute(this.PrivilegedContext, this.PrivilegedContext, testActions.PretestAction);
        ...
        private SqlDatabaseTestActions dbo_fn_remove_lettersTestData;
        private SqlDatabaseTestActions TableNamingData;
    }
}
